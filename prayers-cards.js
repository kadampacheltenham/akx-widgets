...
(function(){
  ...
  var CARDS=[
    ...
    { abbr:'VY', title:'Vajrayogini Practice', freq:'Regularly &middot; 60&ndash;90 mins', img:'vajrayogini.jpg', fig:false,
      ...
      more:'This practice is for those who have received HYT empowerment, or intend to take the empowerments in the near future. There are different <i>sadhanas</i> we practice &ndash; <i>Quick Path to Great Bliss</i>, <i>Dakini Yoga</i> and <i>Blissful Path</i>. <span class="pc-see">See <a href="#calendar">calendar</a> below for when it&rsquo;s on next.</span>' },
  ...
  +"#akx-prayers-cards .pc-tag{top:14px;right:14px;left:auto;transform:none;white-space:nowrap;text-align:center;max-width:none;padding:5px 11px;}"
  ...
  function build(order){
    ...
    order.forEach(function(c,ci){
      ...
      card.innerHTML=
        ...
        +'<button class="pc-rm">What to expect <span class="chev">&#9662;</span></button>'
        +'</div>';
    ...
    track.querySelectorAll('.pc-rm').forEach(function(b){ b.onclick=function(){
      ...
      b.childNodes[0].nodeValue=open?'Show less ':'What to expect '; setTimeout(function(){ height(); placeNav(); },360);
    };});
